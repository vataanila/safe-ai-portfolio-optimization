"""
Step 6c, MLP counterpart of 6a_ridge_portfolio.py / 6b_xgboost_portfolio.py.
Same MIQP frontier, same covariance/turnover/metrics conventions, just fed
with the MLP mu_hat from Step 5c.

Inputs : data/clean/returns.csv, data/clean/meta_clean.csv,
         data/results/step3/baseline_weights.csv,
         data/results/step5/mlp/predictions/ml_mu_mlp.csv
Outputs: data/results/step6/mlp/{weights,returns,performance,logs}/...
         per lambda, plus the aggregated
         data/results/step6/mlp/performance/mlp_frontier_summary.csv
...
# ---------- model identity ---------------------------------------------------
MODEL_NAME = "mlp"
MU_FILE    = "ml_mu_mlp.csv"

# ---------- paths ------------------------------------------------------------
RESULTS_DIR      = os.path.join(BASE_DIR, "data", "results")
STEP3_DIR        = os.path.join(RESULTS_DIR, "step3")
STEP5C_PRED_DIR  = os.path.join(RESULTS_DIR, "step5", "mlp", "predictions")
STEP6_DIR        = os.path.join(RESULTS_DIR, "step6")
MODEL_STEP6_DIR  = os.path.join(STEP6_DIR, "mlp")
...
log("=" * 70)
log("  STEP 6c - MLP ML-ENHANCED MARKOWITZ MIQP PORTFOLIO FRONTIER")
log("=" * 70)
...
mu_path = os.path.join(STEP5C_PRED_DIR, MU_FILE)
...
print("\n" + "=" * 70)
print(f"  STEP 6c -- {MODEL_NAME.upper()} PORTFOLIO FRONTIER COMPLETE")
print("=" * 70)
