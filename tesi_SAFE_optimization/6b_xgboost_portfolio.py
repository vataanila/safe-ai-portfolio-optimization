"""
Step 6b -- same MIQP portfolio frontier as 6a_ridge_portfolio.py
(see that file for the shared covariance/turnover/metrics setup), just
with XGBoost's mu_hat (Step 5b) instead of Ridge's.

Inputs : data/clean/returns.csv, data/clean/meta_clean.csv,
         data/results/step3/baseline_weights.csv,
         data/results/step5/xgboost/predictions/ml_mu_xgboost.csv
Outputs: data/results/step6/xgboost/{weights,returns,performance,logs}/...
         per lambda, plus the aggregated
         data/results/step6/xgboost/performance/xgboost_frontier_summary.csv
...
STEP5B_PRED_DIR  = os.path.join(RESULTS_DIR, "step5", "xgboost", "predictions")
STEP6_DIR        = os.path.join(RESULTS_DIR, "step6")
MODEL_STEP6_DIR  = os.path.join(STEP6_DIR, "xgboost")
...
log("=" * 70)
log("  STEP 6b -- XGBOOST ML-ENHANCED MARKOWITZ MIQP PORTFOLIO FRONTIER")
log("=" * 70)
...
mu_path = os.path.join(STEP5B_PRED_DIR, MU_FILE)
...
print("\n" + "=" * 70)
print(f"  STEP 6b, {MODEL_NAME.upper()} PORTFOLIO FRONTIER COMPLETE")
print("=" * 70)
