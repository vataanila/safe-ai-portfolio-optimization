...
===========================
PURPOSE : Step 6b â€” XGBoost ML-enhanced Markowitz MIQP portfolio construction
          and backtest.
...
PIPELINE:
  ...
  Step 5b â†’ step5b_xgboost_mu.py           (XGBoost mu predictions)
  Step 6a â†’ step6a_portfolio_ridge.py      (Ridge variant)
  Step 6b â†’ this script                    (XGBoost MIQP portfolio, backtested)
...
INPUTS  :
  ...
  data/results/step5/ml_mu_xgboost.csv       -- XGBoost mu_hat (rebal dates Ã— tickers)
...
METHODOLOGY:
  mu  : XGBoost ML predictions loaded from step5b â€” NOT recomputed here.
...
log("=" * 70)
log(f"  STEP 6b â€” XGBOOST ML-ENHANCED MARKOWITZ MIQP PORTFOLIO")
log("=" * 70)
...
print("\n" + "=" * 70)
print(f"  STEP 6b â€” {MODEL_NAME.upper()} PORTFOLIO COMPLETE")
print("=" * 70)
