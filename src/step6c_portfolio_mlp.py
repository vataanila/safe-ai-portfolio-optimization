...
=======================
PURPOSE : Step 6c - MLP ML-enhanced Markowitz MIQP portfolio construction
          and backtest.
...
INPUTS  :
  ...
  data/results/step5/ml_mu_mlp.csv           -- MLP mu_hat (rebal dates x tickers)
...
METHODOLOGY:
  mu  : MLP ML predictions loaded from step5c - NOT recomputed here.
...
log("=" * 70)
log(f"  STEP 6c - MLP ML-ENHANCED MARKOWITZ MIQP PORTFOLIO")
log("=" * 70)
...
print("\n" + "=" * 70)
print(f"  STEP 6c - {MODEL_NAME.upper()} PORTFOLIO COMPLETE")
print("=" * 70)
